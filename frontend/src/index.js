...
import STaskCard from './components/STaskCard.js';
...
const testButton0 = SButton(eventBus, 'test-event-0', 'primary', 'Test 0');
...
const testTaskCard1 = STaskCard(eventBus, 'card-cliked-event', testTask);

// tu dodajemy wszystkie trzy testowe buttony jako dzieci topbaru, po prostu,
// żeby były gdzieś widoczne i dało się ich używać
document.getElementById('topbar').appendChild(testButton0);
...
document.getElementById('topbar').appendChild(testTaskCard1);
...
eventBus.on('test-event-0', () => reaktorNaEvent('test-event-0'));
